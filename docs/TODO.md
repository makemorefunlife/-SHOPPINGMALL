- [ ] Phase 1: 기본 인프라
  - [ ] Next.js 프로젝트 셋업 (pnpm, App Router, React 19)
  - [ ] Clerk 연동 (로그인/회원가입, 미들웨어 보호)
  - [ ] 기본 레이아웃/네비게이션 구성 (`app/layout.tsx`, `components/Navbar.tsx`)
  - [ ] Supabase 프로젝트 연결 및 환경변수 세팅 (`.env.local`)
